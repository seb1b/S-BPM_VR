...
def buildHelper(manager, model):
	...
	state1.hasAbstractVisualRepresentation.setPoint2D(0,1)
	...
	state3.label.append("Bitte um Freigabe")
	state1.hasAbstractVisualRepresentation.setPoint2D(3,1)
