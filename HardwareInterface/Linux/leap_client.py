    ...
    def on_frame(self, controller):
        ...
        # All other actions
            ...
            for hand in frame.hands:
                ...
                #string_to_send += str(ID) + ":" + "{0:.6f}".format(float(current_handpalm_position_x)) + "," + "{0:.6f}".format(float(current_handpalm_position_y)) + "," + "{0:.6f}".format(float(current_handpalm_position_z)) + ":" + handtype + ":" + current_gesture
                string_to_send += str(ID) + ":" + str(current_handpalm_position_x) + "," + str(current_handpalm_position_y) + "," + str(current_handpalm_position_z) + ":" + handtype + ":" + current_gesture
                print(string_to_send)
