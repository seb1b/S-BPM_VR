...
namespace Arges.KinectRemote.Transport
{
    ...
    public class StringReceiver : IDisposable
    {
        ...
        public StringReceiver(string ipAddress, string exchange, string bindingKey, string username = "guest", string password = "guest")
        {
        ...
        /// <summary>
        /// Returns a String if one is ready.  WARNING: This is a blocking call.
        /// </summary>
